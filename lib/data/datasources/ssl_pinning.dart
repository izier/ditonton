...
class SSLPinning {
  static http.Client? clientInstance;

  static Future<void> init() async {
    clientInstance = await instance;
  }

  static Future<http.Client> get instance async => clientInstance ??= await customHttpClient();
  static http.Client get client => clientInstance ?? http.Client();

  static Future<http.Client> customHttpClient({bool isTestMode = false}) async {
